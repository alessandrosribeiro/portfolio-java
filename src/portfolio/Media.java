...
public class Media extends JDialog {
	 ...
	 */
	public Media() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Media.class.getResource("/img/media48x48.png")));
		...
		btnNewButton.setIcon(new ImageIcon(Media.class.getResource("/img/salvar48x48.png")));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				calcular();
			}
		});
		btnNewButton.setBounds(88, 266, 48, 48);
		...
		lblNewLabel_5.setBounds(22, 186, 46, 14);
		getContentPane().add(lblNewLabel_5);

		txtNota3 = new JTextField();
		txtNota3.setBounds(88, 183, 86, 20);
		getContentPane().add(txtNota3);
		txtNota3.setColumns(10);

		JLabel lblNewLabel_6 = new JLabel("4\u00BA Bim");
		lblNewLabel_6.setBounds(22, 217, 46, 14);
		getContentPane().add(lblNewLabel_6);

		txtNota4 = new JTextField();
		txtNota4.setBounds(88, 214, 86, 20);
		getContentPane().add(txtNota4);
		txtNota4.setColumns(10);
		
		JButton btnLimpar = new JButton("");
		btnLimpar.setIcon(new ImageIcon(Media.class.getResource("/img/limpar48x48.png")));
		btnLimpar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				limpar();
			}
		});
		btnLimpar.setBounds(183, 266, 48, 48);
